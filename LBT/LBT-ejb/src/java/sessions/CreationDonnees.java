...
public class CreationDonnees implements CreationDonneesLocal {
    ...
    public void creerDonnees() {
        ...
        Date d01 = new GregorianCalendar(2018, 2, 16, 12, 00, 00).getTime();
        Date d02 = new GregorianCalendar(2018, 2, 17, 12, 30, 00).getTime();
        Date d03 = new GregorianCalendar(2018, 2, 18, 12, 15, 00).getTime();

        Commande c01 = new Commande(d01);
        Commande c02 = new Commande(d01);
        ...
        Reglement r01 = new Reglement(d01, 44); // lc01+lc02
        Reglement r02 = new Reglement(d02, 77); // lc03+lc04
        Reglement r03 = new Reglement(d03, 13.2f); // lc05
        Reglement r04 = new Reglement(d03, 14.3f); // lc06
        Reglement r05 = new Reglement(d01, 72.2f); // lc07
